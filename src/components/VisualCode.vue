    ...
    methods:{
        ...
        drawHline(){
            ...
            for(let i=0, j=this.draw_message['hline'].length; i<j; i++){
                ...
                if(this.filter.indexOf(i+1)!==-1) this.context.strokeStyle = 'rgba(255, 0, 0, '+ this.line_opacity+')'
                else if(this.filter.indexOf(-i-1)!==-1) this.context.strokeStyle = 'rgba(255, 76, 124, '+ this.line_opacity+')'
                else this.context.strokeStyle = 'rgba(0, 0, 0, '+ this.line_opacity+')'
        ...
        drawRect(){
            ...
            for(let i=0; i<this.draw_message['rect'].length; i++){
                if(this.filter.indexOf(i+1)!==-1) this.context.fillStyle = 'rgba(255, 0, 0, '+ this.rect_opacity+')'
                else if(this.filter.indexOf(-i-1)!==-1) this.context.fillStyle = 'rgba(255, 76, 124, '+ this.rect_opacity+')'
                else this.context.fillStyle = 'rgba(0, 0, 0, '+ this.rect_opacity+')'
